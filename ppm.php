...
<head>
    ...
    <section><div class="col-md-12" align="center">    
        <h1>Cálculo de PPM</h1>
    </div>
    <div class="col-md-6">
        <form id="formEnvia" method="get" action="ppm.php" class="form-horizontal">
            <div class="col-md-12">
                <label class="col-md-12 control-label">
                    <h3 align="center">Preencha os campos abaixo para calcular os indicadores de Refugo / PPM:</h3>
                </label>
                <div class="form-group">
                    <label class="col-md-5 control-label" for="horas"><h3>Produção:</h3></label>
                        <div class="col-md-5">    
                ...
                <div class="form-group">
                    <label class="col-md-5 control-label" for="horas"><h3>Refugo:</h3></label>
                        <div class="col-md-5">    
                ...
                <div class="col-md-12">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <h3><input  class="btn btn-primary btn-block" align="center" type="submit" value="Calcular PPM"></h3>
                        </div>                        
                    </div>
            </div>
        </form>
        ...
        <?php
            ...
            if ($produzidas==0){
                $resposta="Preencha os campos Produção e Refugo para calcular seu Percentual de Qualidade e PPM!!!";
                $figura="duvida.png";
                $percentual=0;
                $ppm=0;
            }else{
                ...
                $figura="duvida.png";
                $resposta="Você sabe qual o impacto do refugo no seu processo?";}
        ?>
        <!--Lógica PHP-->
        <form action="ppmResultados.php" class="form-horizontal">
            <div class="form-group">
                <label class="col-md-5 control-label" for="%Refugo"><h3>% de Refugo:</h3></label>
                    <div class="col-md-5">    
                        <input  class="form-control" type="text" value="<?php echo number_format($percentual,2)." %" ?>" name="%percentual" placeholder="%"/>
                    </div>
            </div>
            <div class="form-group">
                <label class="col-md-5 control-label" for="PPM Refugado"><h3>PPM Refugado:</h3></label>
                    <div class="col-md-5">    
